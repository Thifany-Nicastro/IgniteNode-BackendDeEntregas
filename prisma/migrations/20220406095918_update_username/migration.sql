/*
  ...
  - You are about to drop the column `usernamename` on the `clients` table. All the data in the column will be lost.
  - You are about to drop the column `usernamename` on the `deliveryman` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "clients_usernamename_key";

-- DropIndex
DROP INDEX "deliveryman_usernamename_key";

-- AlterTable
ALTER TABLE "clients" DROP COLUMN "usernamename",
ADD COLUMN     "username" TEXT NOT NULL;

-- AlterTable
ALTER TABLE "deliveryman" DROP COLUMN "usernamename",
ADD COLUMN     "username" TEXT NOT NULL;
